...
export const InteractiveWavesBackground: React.FC<WavesProps> = ({
    lineColor = 'rgba(0, 229, 204, 0.12)', // Electric teal with low opacity
    ...
    return (
        <div
            ref={containerRef}
            style={{ backgroundColor, position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0, ...style }}
            className={className}
        >
            <div
                style={{
